...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::dropIfExists('pilsetas');

        DB::select('
              CREATE TABLE vzd.pilsetas (
                id serial4 NOT NULL,
                ...
                CONSTRAINT pilsetas_pkey PRIMARY KEY (id)
            );
        ');

        DB::select('CREATE INDEX sidx_pilsetas_geom ON vzd.pilsetas USING gist (geom)');
